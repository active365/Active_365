...
import { GymContext } from "@/context/GymContext"; // Asegúrate de que la ruta sea correcta
import { ILoginData, ILoginErrors } from "@/interfaces/ILogin";

const LoginGym: React.FC = () => {
  ...
  const { handleGymLogin } = useContext(GymContext);
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (isFormValid) {
      await handleGymLogin(loginData); // Usar el handleGymLogin del contexto
    }
  };
